    ...
    return {
      ...
      data: {
        items: collections.map((c) => ({
          ...
          viewCount: c.content.viewCount,
          downloadCount: c.content.downloadCount,
          favoriteCount: c.content.favoriteCount,
          avgRating: c.content.avgRating,
          ratingCount: c.content.ratingCount,
